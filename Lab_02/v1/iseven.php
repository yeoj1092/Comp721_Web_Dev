...
<body>
    ...
    if (is_int($num) && $num % 2 == 0) {
        // If the condition is true, set the message to "The number is even."
        $message = "The number $num is even.";
    } else {
        // If the condition is false, set the message to "The number is not even."
        $message = "The number $num is not even.";
    }
